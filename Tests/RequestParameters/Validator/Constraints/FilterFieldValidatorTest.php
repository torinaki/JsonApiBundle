...
use Mango\Bundle\JsonApiBundle\RequestParameters\Validator\Constraints\FilterFieldValidator;
use Mango\Bundle\JsonApiBundle\RequestParameters\Validator\Constraints\FilterField;
use Mango\Bundle\JsonApiBundle\RequestParameters\GetParametersAbstract;

/**
 * Tests for FilterFieldValidator validator
 *
 * @author  Vlad Yarus <vladislav.yarus@ecentria.com>
 */
class FilterFieldValidatorTest extends ConstraintValidatorTestCase
{
    /**
    ...
    public function testValidate($value, $availableFields, $expected)
    {
        ...
        $params->expects($this->once())
            ->method('getAvailableFilterFields')
        ...
        if ($expected) {
            ...
            $this->buildViolation("Field '{{ field_name }}' is not allowed for filtering.")
    ...
    {
        return new FilterFieldValidator();
    }
}
