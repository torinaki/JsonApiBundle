...
/**
 * FilterFieldValidator validator
 *
 * @author  Vlad Yarus <vladislav.yarus@ecentria.com>
 */
class FilterFieldValidator extends ConstraintValidator
{
    /**
     * {@inheritdoc}
     */
    public function validate($value, Constraint $constraint)
    {
        ...
        if (!in_array($value, $object->getAvailableFilterFields(), true)) {
